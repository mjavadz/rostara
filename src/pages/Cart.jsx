        ...
        return (
            <div className="min-h-screen bg-cream flex items-center justify-center px-4">
                <div className="text-center max-w-md">
                    <div className="inline-flex items-center justify-center w-24 h-24 bg-brown-100 rounded-full mb-6">
                        <ShoppingCart className="w-12 h-12 text-brown-400" />
                    </div>
    ...
    return (
        <div className="min-h-screen bg-cream pt-32 pb-20">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl md:text-5xl font-display font-bold text-brown-900 mb-2">
                        {t('cart.title')}
                    </h1>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {cartItems.map((item) => (
                            <div
                                key={item.id}
                                className="bg-white rounded-2xl p-6 border border-brown-100 hover:shadow-lg transition-shadow"
                            >
                                <div className="flex gap-6">
                                    {/* Product Image Placeholder */}
                                    <div className="w-24 h-24 bg-gradient-to-br from-primary-100 to-brown-100 rounded-xl flex items-center justify-center flex-shrink-0">
                                        <Package className="w-10 h-10 text-primary-600/30" />
                                    </div>
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex items-center justify-between flex-wrap gap-4">
                                            {/* Quantity Controls */}
                                            <div className="flex items-center gap-3 bg-cream rounded-xl p-1">
                                                <button
                                                ...
                                                <span className="w-12 text-center font-bold text-brown-900">
                                                    {item.quantity}
                                                </span>
                                                <button
                                                    onClick={() => updateQuantity(item.id, item.quantity + 1)}
                                            ...
                                            >
                                                <Trash2 className="w-5 h-5 text-brown-400 group-hover:text-red-600" />
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl p-6 border border-brown-100 sticky top-32">
                            ...
                            <Link
                                to="/products"
                                className="block w-full mt-4 py-3 text-center text-primary-600 hover:bg-primary-50 rounded-xl font-medium transition-colors"
                            >
