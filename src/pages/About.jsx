...
const About = () => {
    ...
    const values = [
        ...
        },
        {
            ...
            description: 'تعهد قطعی به بذرها غیرتراریخته، بدون استفاده از حتی یک قطره کود شیمیایی، آفت‌کش یا علف‌کش‌های صنعتی.'
        },
        {
            icon: Sparkles,
            ...
            <section className="py-20 bg-white dark:bg-brown-900 transition-colors duration-300">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="prose prose-lg max-w-none text-brown-800 dark:text-brown-200 space-y-6 leading-relaxed">
                        ...
                        <p>
                            هدف رُستارا این است که با ارائه باکیفیت‌ترین بذرها ارگانیک، کیت‌های رشد استاندارد خانگی، خوراکی‌های تخمیری زنده و دانش کاربردی، شما را به کشاورز و حامی سلامت خود و خانواده‌تان تبدیل کند.
                        </p>
                    </div>
                </div>
            </section>
